...
//--Anañiendo el contenido a las variables
  ...
  time.innerText= "Hora del tweet: " + date.getHours()+ ":" + date.getMinutes();//hora:minutes
...
//--Condicional para permitir enviar o bloquear el envio a caracteres que superen los 140
  ...
  if (maxChar<=0) {
    console.log("No puedes enviar, ¡has agotado el número de carácteres!");
  ...
  if (maxChar>0 && maxChar<=10) {
    console.log("Te restan "+ maxChar +" carácteres");
    contentSpan.style.color="#BE1931";//Cambio de color a rojo en el # de caracteres para advertir que se esta cerca del límite de carácteres

  } if (maxChar>10) {
    console.log("Boton habilitado");
    contentSpan.style.color="#55ACEE";//Color azul en contador de carácteres para indicar que aun no se aproxima el límite de carácteres a usar
  }
